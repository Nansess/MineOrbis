...
#ifdef __ORBIS__
		// Keep PS4 saves synchronous. The async queue path is the last thread-heavy
		// save stage and has been the remaining unstable runtime path on ORBIS.
		PIXBeginNamedEvent(0,"Closing output stream");
		output->close();
