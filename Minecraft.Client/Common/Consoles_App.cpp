...
#elif __ORBIS__
		// Relative paths on Orbis go through the Win32/FIOS shim and have been
		// failing to stat packaged media even when the file is present in app0.
		// Use the explicit application mount path for the main media archive.
		mediapath = L"/app0/Common/Media/MediaOrbis.arc";
#elif _DURANGO
